...
> 🌐 在线访问：**https://aust24lzy.github.io/dsh-plugin-hub/**
...
- GitHub Actions **每小时**自动同步并部署到 GitHub Pages
...
├── .github/workflows/      # 自动同步 + 部署到 GitHub Pages
└── LICENSE                 # MIT 协议
```
...
3. 推送代码到 `main` 分支，或手动在 `Actions` 页运行 `Sync & Deploy` workflow

部署成功后，站点地址为 `https://aust24lzy.github.io/dsh-plugin-hub/`。
